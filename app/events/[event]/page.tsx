  ...
  return !isLoading && !currentUserIsLoading && event ? (
    <div className="flex flex-col px-4 mt-[50px]">
      <div className="flex justify-between">
        ...
        <Button size="small" onClick={() => handleClickAdvertise()}>
          홍보하기
        </Button>
        <Toaster />
      </div>
      ...
      <div className="flex justify-between mt-4">📍 {event?.location}</div>
      <div className="mt-4">👑 {event?.owner_name}</div>
      <div className="mt-4 whitespace-pre-line leading-normal break-all">
        {event?.description}
      </div>
