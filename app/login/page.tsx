    ...
    <form onSubmit={formik.handleSubmit}>
      <div className="flex flex-col mx-auto mt-[100px] max-w-[360px]">
        ...
        <div
          ...
          className="text-xs text-right ml-auto mt-4 cursor-pointer w-fit"
        >
          아이디를 잊으셨나요?
        </div>
        <Link
        ...
        <Link href="/register" className="w-full no-underline text-black">
          <Button
            color="orange"
            variant="filled"
            className="text-center mt-4 border-none w-full"
          >
            회원가입
          </Button>
        </Link>
        <div className="mt-4 mx-auto font-bold text-[#FF0000]">
