    ...
    <div>
        ...
        <div className="grid min-h-screen px-8">
          <div className="container relative z-10 my-auto mx-auto grid place-items-center text-center">
            <Button color="success">
              <Link href="/join">지원하기/연장하기</Link>
            </Button>

            <Link>인스타그램에서 활동사진 보기</Link>
      ...
      <section className="py-12 px-4">
        <div className="mx-auto max-w-screen-md">
          ...
          <Card className="my-12 font-normal !text-gray-500">
            <CardBody>
              동아리 연혁 <br />
              - 1기 : 2019.11. 모집 <br />
              - 2기 : 2020~2021년 모집 <br />
          ...
          <Card className="mt-8 mb-6">아지트를 소개합니다!</Card>

          <Card className="my-10 font-normal !text-gray-500">
          ...
          <section className="w-full max-w-full mx-auto flex flex-col items-center py-20">
            <Card className="text-center">이런 활동들을 해요</Card>
            <div className="mt-10 gap-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div className="!border-b  border-blue-gray-100 mb-5">
                  <Card>
                    <CardBody className="p-0 pb-5">
                      정모 매주 토요일마다 운영진이 책임지고 가는 정모가
                      열립니다. 보드게임 뉴비에서 고인물까지 모두 재밌고
                      편안하게 보드게임해요!
                    </CardBody>
                  </Card>
                </div>
                <div className="!border-b md:border-none border-blue-gray-100 mb-5">
                  <Card>
                    <CardBody className="p-0 pb-5">
                      ...
                      <Card className="leading-[45px] mb-4 !text-gray-900 ">
                        지니어스 대회
                      </Card>
                      <Card className="text-normal mb-4 !text-base text-blue-gray-500 ">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <Card className="!font-bold !text-sm text-gray-900">
                            지니어스 참가자
                          </Card>
                          <Card className="!font-normal !text-xs text-gray-500">
                            감보동 3기
                          </Card>
                        </div>
                      </div>
                ...
                <div className="!border-b md:border-none border-blue-gray-100 mb-5">
                  <Card>
                    <CardBody className="p-0 pb-5">
                      ...
                      <Card className="leading-[45px] mb-6 !text-gray-900">
                        MT 및 여행
                      </Card>
                    </CardBody>
                  </Card>
              ...
              <div>
                <div className="!border-b md:border-none border-blue-gray-100 mb-5">
                  <Card className="pb-5 p-0 !border-b md:border-none border-blue-gray-100">
                    <CardBody className="p-0 ">
                      ...
                      <Card className="font-normal mb-4 !text-base text-gray-500 ">
                ...
                <div className="!border-b md:border-none border-blue-gray-100 mb-5">
                  <Card>
                    <CardBody className="p-0 pb-5">
                      ...
                      <Card className="!font-bold !text-sm text-gray-700">
                        티츄 등 각종 보드게임 대회 개최
                      </Card>
                    </CardBody>
                  </Card>
